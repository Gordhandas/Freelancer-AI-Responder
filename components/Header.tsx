            ...
            <div className="max-w-8xl mx-auto px-4 sm:px-6 md:px-8 py-4">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-xl sm:text-2xl font-bold text-white tracking-tight">Freelancer AI Responder</h1>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        >
                            <ChatBubbleIcon />
                            <span className="hidden sm:inline">{isSidebarVisible ? 'Hide' : 'Show'} Conversations</span>
                        </button>
                         <button
